...
const getListaDeEstados = (estado) => {
   let uf = []
   ...
   let JsonEstados = {
      //Colocando lista UF que criamos dentro de UF
      uf: uf,
      // Colocando a quantiade de UF de Estados dentro de quantidades
      quantidade: estadosECidades.estados.length
   }

   return JsonEstados;
}

//console.log(getListaDeEstados(estadosECidades))
   ...
   estadosECidades.estados.forEach(function(estado){
      if(estado.capital_pais != undefined){
         let dados = {
            ...
            nome: estado.nome,
            capital: estado.capital,
            capital_ano_inicio: estado.capital_pais.ano_fim,
            capital_ano_fim: estado.capital_pais.ano_inicio
         }

         listaCapitais.push(dados);
   ...
   estadosECidades.estados.forEach(function(estado){
      if(estado.sigla == siglaEstado){
         ...
         estado.cidades.forEach(function(cidades){
            ...
            resultadoFinalJson = resultadoFinal
         })
      }
   })
   return resultadoFinalJson;
